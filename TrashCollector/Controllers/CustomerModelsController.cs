...
namespace TrashCollector.Controllers
{
    public class CustomerModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,IdentityUserId")] CustomerModel customerModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,IdentityUserId")] CustomerModel customerModel)
        {
